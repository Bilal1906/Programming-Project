...
const docenten = {
  'Joachim Quartier': {
    email: 'joachim.quartier@docent.ehb.be',
    telefoon: '+32 473 44 55 66',
  },
  'Tom Aertssens': {
    email: 'tom.aertssens@docent.ehb.be',
...
const stagementors = {
  'Steve Weemaels': {
    email: 'steve.weemaels@accenture.com',
    bedrijf: 'Accenture Belgium',
  },
  'David Van Steertegem': {
    email: 'david.vansteertegem@delaware.be',
    bedrijf: 'Delaware',
  },
  'Lars Vermeulen': {
    email: 'lars.vermeulen@cegeka.com',
    bedrijf: 'Cegeka',
  },
  'Emma De Ridder': {
    email: 'emma.deridder@ordina.be',
    bedrijf: 'Ordina',
  },
};
...
const bedrijven = {
  ...
  Delaware: {
    email: 'info@delaware.be',
  },
  Cegeka: {
    email: 'info@cegeka.com',
  },
  Ordina: {
    email: 'info@ordina.be',
  },
};
